...
items = [
  ...
  {name: "Нижний-Новгород", code: "NNG", tile_stations_url: 'nktb.9rbfma6e', tile_routes_url: 'nktb.2gsyq2nz', tile_density_url: '', longitude:43.7857419, latitude: 56.2921286},
  {name: "Самара", code: "SAM", tile_stations_url: 'nktb.9fb34p6e', tile_routes_url: 'nktb.be0kl4tk', tile_density_url: '', longitude:50.0576522, latitude: 53.2610309},
